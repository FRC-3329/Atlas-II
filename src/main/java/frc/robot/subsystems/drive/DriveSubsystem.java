...
public class DriveSubsystem extends SubsystemBase {
    ...
    public void addVisionMeasurement(
            ...
            double timestampSeconds,
            Matrix<N3, N1> visionMeasurementStdDevs) {
        addVisionMeasurement(visionRobotPoseMeters.toPose2d(), timestampSeconds, visionMeasurementStdDevs);
    }
    ...
    public Command lockWheels() {
        return run(this::stopWithX).withName("DriveLockWheels");
    }

    /** Sets every module to brake or coast mode. */
