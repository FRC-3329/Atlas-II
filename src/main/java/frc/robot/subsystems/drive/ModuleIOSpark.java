...
/**
 * Module IO implementation for Spark Max drive/turn controllers with a CANcoder
 * steering reference.
 */
public class ModuleIOSpark implements ModuleIO {
    ...
    private void syncTurnEncoderWithAbsolute() {
        ...
        tryUntilOk(turnSpark, 5, () -> turnEncoder.setPosition(getAbsoluteAngleRadians()));
    }

    private Rotation2d getAbsoluteAngle() {
        return Rotation2d.fromRotations(turnAbsolutePosition.getValueAsDouble()).minus(zeroRotation);
    }

    private double getAbsoluteAngleRadians() {
        return getAbsoluteAngle().getRadians();
    }
}
