...
public final class TurretConstants {
    ...
    public static final double ABSOLUTE_ENCODER_FULL_RANGE = 360.0;
    public static final double ABSOLUTE_ENCODER_OFFSET = -180.0;
    public static final boolean USE_ABSOLUTE_ENCODER = true;

    /** Y offsets for aiming at free space above/below the hub from opponent zone. */
    ...
    /** Wider than the MotionMagic tolerance so LEDs light up slightly early. */
